 ...
 * maxPixels is 0 for no admission limit. A larger valid image returns
 * WEBP_ERROR_DEFERRED with no decoder or bitmap; info contains its size.
 */
...
WebPImportBegin(FileHandle source, VMFileHandle destination,
                ...
                WebPImageInfo *info, dword maxPixels);
