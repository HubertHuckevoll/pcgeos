...
/* --- Import alpha handling --- */
typedef enum
{
    QOI_AT_MASK = 0,
    QOI_AT_BLEND
} QoiAlphaTransformMethod;

typedef struct
{
    QoiAlphaTransformMethod   QATD_method;
    byte                      QATD_alphaThreshold;
    RGBValue                  QATD_blendColor;
} QoiAlphaTransformData;

/* Optional alpha transform-aware import helpers */
...
/* Compatibility helpers (legacy global knob API) */
