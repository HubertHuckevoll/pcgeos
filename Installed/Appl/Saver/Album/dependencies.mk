album.rdef: generic.uih product.uih saver.uih
album.obj \
album.eobj: stdapp.def geos.def geode.def resource.def ec.def lmem.def \
                ...
                timer.def initfile.def Internal/heapInt.def \
                Internal/semInt.def sysstats.def fileEnum.def \
                backgrnd.def saver.def album.rdef

albumEC.geo album.geo : saver.ldf ui.ldf geos.ldf 