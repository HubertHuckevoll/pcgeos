hello.rdef: generic.uih product.uih
hello.obj \
hello.eobj: geos.def heap.def geode.def resource.def ec.def object.def \
                lmem.def graphics.def fontID.def font.def color.def \
                gstring.def text.def char.def Objects/winC.def win.def \
                Objects/metaC.def chunkarr.def geoworks.def ui.def \
                file.def vm.def input.def hwr.def localize.def sllang.def \
...
helloEC.geo hello.geo : geos.ldf ui.ldf 