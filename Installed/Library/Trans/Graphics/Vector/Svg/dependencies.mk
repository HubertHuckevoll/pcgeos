svgAdapter.obj \
svgAdapter.eobj: stdapp.goh object.goh ui.goh Objects/metaC.goh \
                ...
                Objects/helpCC.goh
svgAdapter.obj \
svgAdapter.eobj: geos.h heap.h geode.h resource.h ec.h object.h lmem.h \
                ...
                parallDr.h hugearr.h fileEnum.h svgLib.h xlatLib.h
svgManager.obj \
svgManager.eobj: stdapp.def geos.def geode.def resource.def ec.def lmem.def \
...
svgEC.geo svg.geo : geos.ldf impex.ldf svglib.ldf 