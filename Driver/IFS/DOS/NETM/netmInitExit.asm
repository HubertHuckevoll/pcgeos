...
NetmInit	proc	far
	...
	;
		mov	cx, segment NetmStrategy
		mov	dx, offset NetmStrategy
		mov	ax, FSD_FLAGS
		mov	bx, handle 0
		...
		call	NetmInitLocateDrives

		call	NetmInitClearLocalBits

		segmov	es, ds
		call	NetmInitOpenFiles
	;
	...
	;
		...
		mov	bx, segment NetmIdleHook
		mov	cx, offset NetmIdleHook
		mov	ax, 28h
	...
	;
		...
		mov	bx, segment NetmCriticalError
		mov	cx, offset NetmCriticalError
...
nextEntry:
		...
		.leave
		ret
NetmInitLocateDrives endp


COMMENT @%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		NetmInitClearLocalBits
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%@
NetmInitClearLocalBits proc	near
		.enter
	;
...
CALLED BY:	NetmInitOpenFiles via FileForEach
