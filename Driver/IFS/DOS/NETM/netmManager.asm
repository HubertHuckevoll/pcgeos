...
include netmConstant.def

;------------------------------------------------------------------------------
;				Variables
;------------------------------------------------------------------------------

include netmStrings.asm
include	netmVariable.def

;------------------------------------------------------------------------------
;				Code
;------------------------------------------------------------------------------

include	netmEntry.asm	; strategy & administrative gradoo
include	netmDisk.asm		; DR_FS_DISK* implementation
include netmInitExit.asm	; Initialization/exit routines.
include netmSecondary.asm	; Support routines for primary to call
include netmUtils.asm	; Random utility things.
include netmHooks.asm
