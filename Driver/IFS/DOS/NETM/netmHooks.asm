...
ROUTINES:
	Name			Description
	----			-----------
	NetmIdleHook		Let the network know the system is idle
	NetmCriticalError	Catch network-related critical errors
...
NetmIdleHook	proc	far
	...
	;
		...
		jmp	NetmPassOnInterrupt
NetmIdleHook	endp


COMMENT @-----------------------------------------------------------------------

FUNCTION:	NetmCriticalError
