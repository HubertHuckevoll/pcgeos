...
nextDrive:
	...
	;--------------------
	;Pass:		ds:si	= NetmDeviceName to try and map
	;Return:	carry set on error
	;		carry clear if ok:
	;			bx	= DSE offset
	;			si, es, di = destroyed
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%@
NetmCheckNetPath proc	far
		.enter
		clr	bx		; not ours, for now
		.leave
		ret
NetmCheckNetPath endp
