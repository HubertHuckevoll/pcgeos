...
TransExport proc far
	uses    es,ds,si,di
		...
		;call    FloatInit
		call    QOIEXPORT            ; Call high-level procedure to do work
		;call    FloatExit
...
_vmc    local   dword
		...
		;mov     bl,FLOAT_STACK_GROW
		;call    FloatInit
		call    QOIIMPORT            ; Call high-level procedure to do work
		;call    FloatExit
		mov     bx,dx                 ; BX:AX returns error code or format ID
...
TransGetFormat proc far
	uses    es,ds,si,di
		...
		;mov     bl,FLOAT_STACK_GROW
		;call    FloatInit
		call    QOITESTFILE          ; Call high-level procedure to do work
		;call    FloatExit
